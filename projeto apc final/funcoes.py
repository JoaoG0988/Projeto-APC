...
#from menudojogo import game_over1



def telainicial():
    print(' ')
    print('Boas vindas ao Confusion in space !!! ')
    print(' ')
    print('+='* 30)
    print(' ')
...
# Aqui está todo o código principal do jogo
def main():
    pygame.init()
    ...
    pygame.display.set_caption("Baguncinha Espacial")

    # Elementos do jogo
    jogador = pygame.Rect(0, 42, tamanho,tamanho)
    combust = [pygame.Rect(random.randint(1390, 2000),random.randint(0, 90), inimigo_largura, inimigo_altura) for _ in range(probF)]
